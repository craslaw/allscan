...
// ============================================================================
// Syft Parser - Anchore Syft SBOM Generator
// ============================================================================

// SyftParser parses Anchore Syft SBOM (Software Bill of Materials) output.
// Syft catalogs packages and generates SBOMs; it does not detect vulnerabilities.
// Package counts are reported as Info findings.
...
func (p *SyftParser) Name() string { return "syft" }
func (p *SyftParser) Type() string { return "SCA" }
func (p *SyftParser) Icon() string { return "📋" }

func (p *SyftParser) Parse(data []byte) (FindingSummary, error) {
	...
	// Syft reports packages, not vulnerabilities; count packages as Info findings
	summary.Info = len(output.Artifacts)
	summary.Total = summary.Info

	return summary, nil
}

// Verify SyftParser implements SCAParser
var _ SCAParser = (*SyftParser)(nil)
